...
let projects = [{ id: 1, name: 'Eins', description: 'Das Erste' }, { id: 2, name: 'Zwei', description: 'Das Zweite' }];
...
storiesOf('ProjectsOverview', module)
    ...
    .add('hooks', () => {
        fetchMock
            .restore()
            .get('https://apiserver/projects', new Promise((resolve) => setTimeout(resolve, 800)).then(() => projects));
        return (
