            ...
            <div className="App">
                ...
                <Switch>
                    <Route
                        path="/"
                        exact={true}
                        render={() => <ProjectsOverview projects={this.state.projects} onSave={this.createProject} />}
                    />
                    <Route
                        path="/project/:number"
                            ...
                            <ProjectView
                                ...
                                project={
                                    this.state.projects.filter(
                                        (project: Project) => project.id === parseInt(props.match.params.number, 10)
                                    )[0]
                                }
                            />
                        )}
